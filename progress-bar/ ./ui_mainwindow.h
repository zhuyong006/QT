...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(611, 436);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        progressBar = new QProgressBar(centralWidget);
        progressBar->setObjectName(QStringLiteral("progressBar"));
        progressBar->setGeometry(QRect(120, 90, 311, 61));
        progressBar->setValue(24);
        splitter = new QSplitter(centralWidget);
        splitter->setObjectName(QStringLiteral("splitter"));
        splitter->setGeometry(QRect(170, 200, 200, 100));
        splitter->setOrientation(Qt::Horizontal);
        Start = new QPushButton(splitter);
        Start->setObjectName(QStringLiteral("Start"));
        splitter->addWidget(Start);
        Pause = new QPushButton(splitter);
        Pause->setObjectName(QStringLiteral("Pause"));
        splitter->addWidget(Pause);
